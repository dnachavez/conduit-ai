      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="rounded-lg bg-card p-12">
          <form className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                name="email"
                type="email"
                placeholder="Your workspace email address"
                required
          ...
          <div className="space-y-3">
            <button className="flex w-full items-center justify-center rounded border border-muted bg-transparent px-4 py-2 text-sm font-medium hover:bg-accent">
